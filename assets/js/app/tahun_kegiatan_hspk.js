mainApp.controller('tahun_kegiatan_hspk', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'tahun_kegiatan_hspk/getData',
			params: params
		}).then(
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'tahun_kegiatan_hspk/deleteData',
					data: formData,
					method: 'POST',
					headers: {
