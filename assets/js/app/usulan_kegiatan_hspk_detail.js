mainApp.controller('usulan_kegiatan_hspk_detail', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'usulan_kegiatan_hspk_detail/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'usulan_kegiatan_hspk_detail/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'usulan_kegiatan_hspk_detail/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'usulan_kegiatan_hspk_detail/deleteData',
					data: formData,
					method: 'POST',
					headers: {
	...
	$scope.setujuiUsulan = function (params) {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				httpHandler.send({
					url: urls + 'usulan_kegiatan_hspk_detail/setujuiUsulan',
					data: formData,
					method: 'POST',
