mainApp.controller('kegiatan_asb', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'kegiatan_asb/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'kegiatan_asb/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'kegiatan_asb/deleteData',
					data: formData,
					method: 'POST',
					headers: {
