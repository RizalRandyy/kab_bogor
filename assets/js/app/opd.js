mainApp.controller('opd', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'opd/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'opd/form/edit?id='+params.id);
	}
