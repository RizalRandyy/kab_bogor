mainApp.controller('kelompok_item', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'kelompok_item/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'kelompok_item/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'kelompok_item/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'kelompok_item/deleteData',
					data: formData,
					method: 'POST',
					headers: {
