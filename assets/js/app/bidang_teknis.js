mainApp.controller('bidang_teknis', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'bidang_teknis/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'bidang_teknis/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'bidang_teknis/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'bidang_teknis/deleteData',
					data: formData,
					method: 'POST',
					headers: {
