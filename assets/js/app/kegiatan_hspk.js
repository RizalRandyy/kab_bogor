mainApp.controller('kegiatan_hspk', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'kegiatan_hspk/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'kegiatan_hspk/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'kegiatan_hspk/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'kegiatan_hspk/deleteData',
					data: formData,
					method: 'POST',
					headers: {
