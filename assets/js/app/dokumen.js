mainApp.controller('dokumen', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.lihat = function (params) {
		window.location.replace(urls + 'dokumen/show?id='+params.id);
	}
