mainApp.controller('tahun_pekerjaan_detail', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'tahun_pekerjaan_detail/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'tahun_pekerjaan_detail/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'tahun_pekerjaan_detail/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'tahun_pekerjaan_detail/deleteData',
					data: formData,
					method: 'POST',
					headers: {
