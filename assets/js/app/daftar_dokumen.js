mainApp.controller('daftar_dokumen', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'daftar_dokumen/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'daftar_dokumen/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'daftar_dokumen/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'daftar_dokumen/deleteData',
					data: formData,
					method: 'POST',
					headers: {
