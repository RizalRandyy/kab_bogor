mainApp.controller('tahun_kegiatan_asb', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
	...
	$scope.getData = function (pageno) {
		...
		httpHandler.send({
			method: 'GET',
			url: urls + 'tahun_kegiatan_asb/getData',
			params: params
		}).then(
	...
	$scope.tambah = function () {
		window.location.replace(urls + 'tahun_kegiatan_asb/form/tambah');
	}

	$scope.edit = function (params) {
		window.location.replace(urls + 'tahun_kegiatan_asb/form/edit?id='+params.id);
	}
	...
	$scope.delete = function (params) {
		Swal.fire({
			...
			if (result.value) {
				...
				httpHandler.send({
					url: urls + 'tahun_kegiatan_asb/deleteData',
					data: formData,
					method: 'POST',
					headers: {
