mainApp.controller('standar_biaya_tahun', ['$scope', 'httpHandler', '$filter', '$attrs', function ($scope, httpHandler, $filter, $attrs) {
    ...
    $scope.getData = function (pageno) {
        ...
        httpHandler.send({
            method: 'GET',
            url: urls + 'standar_biaya_tahun/getData',
            params: params
        }).then(
    ...
    $scope.tambah = function () {
        window.location.replace(urls + 'standar_biaya_tahun/form/tambah');
    }

    $scope.edit = function (params) {
        window.location.replace(urls + 'standar_biaya_tahun/form/edit?id='+params.id);
    }
    ...
    $scope.delete = function (params) {
        Swal.fire({
            ...
            if (result.value) {
                ...
                httpHandler.send({
                    url: urls + 'standar_biaya_tahun/deleteData',
                    data: formData,
                    method: 'POST',
                    headers: {
