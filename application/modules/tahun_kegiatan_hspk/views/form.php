												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<select class="form-control" id="idKegiatan" ng-model="idKegiatan">
															...
															<option ng-repeat="option in options" value="{{option.id}}" name="{{option.id}}" id="{{option.id}}">{{option.namaBidangTeknis}} - {{option.idKegiatan}} - {{option.UraianKegiatan}} - ({{option.satuan}})</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
