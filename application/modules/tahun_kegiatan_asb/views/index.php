			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row mt-2">
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:25px; margin-bottom:25px;">
						<h3><?= $title ?></h3>
						<span>Isian ASB > Tahun Kegiatan ASB</span>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:37px;">
						<?php if ($users['role_access']['tahun_kegiatan_asb']['accessadd_tahun_kegiatan_asb'] == 'on') { ?>
									...
									<table class="table table-striped table-md" style="font-size: 12px;">
										<thead>
											<tr>
												...
												<?php if ($users['role_access']['tahun_kegiatan_asb']['accessedit_tahun_kegiatan_asb'] == 'on' || $users['role_access']['tahun_kegiatan_asb']['accessdelete_tahun_kegiatan_asb'] == 'on') { ?>
											...
											<tr ng-hide="loading" dir-paginate="(key, value) in data|itemsPerPage:itemsPerPage" total-items="total_count" current-page="curPage" pagination-id="paginateID">
												...
												<?php if ($users['role_access']['tahun_kegiatan_asb']['accessedit_tahun_kegiatan_asb'] == 'on' || $users['role_access']['tahun_kegiatan_asb']['accessdelete_tahun_kegiatan_asb'] == 'on') { ?>
													<td class="text-center" style="white-space: nowrap;">
														<?php if ($users['role_access']['tahun_kegiatan_asb']['accessedit_tahun_kegiatan_asb'] == 'on') { ?>
															<a href="" class="btn btn-success btn-sm p-1" title="Edit: {{value.title}}" ng-click="edit(value)">
																<i class="fas fa-edit"></i>&nbsp;
															</a>
														<?php } ?>
														<?php if ($users['role_access']['tahun_kegiatan_asb']['accessdelete_tahun_kegiatan_asb'] == 'on') { ?>
