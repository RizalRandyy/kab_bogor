...
class Kegiatan_asb extends My_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('Kegiatan_asb_model');
	}

	public function index_get()
	{
		$this->data['title'] = 'Kegiatan ASB';
		$this->data['page'] = 'kegiatan_asb';
		$this->data['version'] = 'kegiatan_asb';
		$this->data['css'] = [
			'assets/plugins/animate/animate.min.css'
		];

		$this->data['js'] = array(
			'assets/js/app/kegiatan_asb.js?' . rand(),
	...
	{
		$return = $this->Kegiatan_asb_model->getData($this->get(NULL, TRUE), $this->data['users']);
		$return['header'] = $this->Kegiatan_asb_model->getheader();
	...
	public function form_get()
	{
		...
		$this->data['title'] = ucfirst($segment) . ' Kegiatan ASB';
		$this->data['page'] = 'tambah_kegiatan_asb';
		$this->data['version'] = $this->uri->segment(2);
		$this->data['id'] = @$this->get('id') ? $this->get('id', TRUE) : null;

		$this->data['js'] = array(
			'assets/js/app/tambah_kegiatan_asb.js?' . rand(),
			'assets/plugins/sweetalert2/dist/sweetalert2.all.min.js',
	...
	{
		$return = $this->Kegiatan_asb_model->getOpd();
	...
	{
		$return = $this->Kegiatan_asb_model->getkel_spesifikasi();
	...
	public function saveData_post()
	{
		...
		$return = $this->Kegiatan_asb_model->saveData($params);
	...
	{
		$return = $this->Kegiatan_asb_model->getReqById($this->get('id', TRUE), $this->data['users']);
	...
	{
		$return = $this->Kegiatan_asb_model->deleteReq($this->post('id', TRUE));
		$this->response($return, $return['status']);
	}
}
