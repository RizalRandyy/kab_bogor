			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row mt-2">
					...
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:37px;">
						<?php if ($users['role_access']['bidang_teknis']['accessadd_bidang_teknis'] == 'on') { ?>
									...
									<table class="table table-striped table-md" style="font-size: 12px;">
										<thead>
											<tr>
												...
												<th class="text-center">Kode Bidang Teknis</th>
												<th class="text-center">Nama Bidang Teknis</th>
												<?php if ($users['role_access']['bidang_teknis']['accessedit_bidang_teknis'] == 'on' || $users['role_access']['bidang_teknis']['accessdelete_bidang_teknis'] == 'on') { ?>
										...
										<tbody>
											...
											<tr ng-hide="loading" dir-paginate="(key, value) in data|itemsPerPage:itemsPerPage" total-items="total_count" current-page="curPage" pagination-id="paginateID">
												...
												<td ng-bind="value.idBidangTeknis"></td>
												<td ng-bind="value.namaBidangTeknis"></td>
												<?php if ($users['role_access']['bidang_teknis']['accessedit_bidang_teknis'] == 'on' || $users['role_access']['bidang_teknis']['accessdelete_bidang_teknis'] == 'on') { ?>
													<td class="text-center" style="white-space: nowrap;">
														<?php if ($users['role_access']['bidang_teknis']['accessedit_bidang_teknis'] == 'on') { ?>
															<a href="" class="btn btn-success btn-sm p-1" title="Edit: {{value.idBidangTeknis}}" ng-click="edit(value)">
																<i class="fas fa-edit"></i>&nbsp;
															</a>
														<?php } ?>
														<?php if ($users['role_access']['bidang_teknis']['accessdelete_bidang_teknis'] == 'on') { ?>
															<a href="" class="btn btn-danger btn-sm p-1" title="Delete: {{value.idBidangTeknis}}" ng-click="delete(value)">
