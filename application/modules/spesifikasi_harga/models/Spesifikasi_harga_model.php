...
class Spesifikasi_harga_model extends CI_Model
{
    public function getData($params, $users)
    {
        ...
        $this->db->select('tb_thn_harga.id,
                tb_thn_harga.kodeKelompok,
                TahunHarga,
                harga,
                tb_spesifikasi_item.id as idSpesifikasi,
                tb_spesifikasi_item.UraianSpesifikasi,
                tb_spesifikasi_item.satuan,
                tb_jenis_item.id as idJenisBrg,
                tb_jenis_item.NamaJenis,
                tb_kelompok_item.id as idKelBrg,
