			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row mt-2">
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:25px; margin-bottom:25px;">
						<h3><?= $title ?></h3>
						<span>Usulan > Isian HSPK > Kegiatan HSPK Detail > <?= $title ?></span>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<select class="form-control" id="idKegiatan" ng-model="idKegiatan">
															...
															<option ng-repeat="x in options_kegiatan" value="{{x.id}}" name="{{x.id+'-'+x.idKegiatan}}" id="{{x.id+'-'+x.idKegiatan}}">{{x.namaOpd}} - {{x.idKegiatan}} - {{x.UraianKegiatan}} - ({{x.satuan}}) - {{x.tahunPekerjaan}}</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
