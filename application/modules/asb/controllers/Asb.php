...
class Asb extends My_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('Asb_model');
	}
	...
	public function index_get()
	{
		$this->data['title'] = 'ASB';
		$this->data['page'] = 'asb';
		$this->data['version'] = 'asb';
		$this->data['css'] = [
			'assets/plugins/animate/animate.min.css'
		];

		$this->data['js'] = array(
			'assets/js/app/asb.js?' . rand(),
	...
	{
		$return = $this->Asb_model->getData($this->get(NULL, TRUE),$this->data['users']);
		$return['header'] = $this->Asb_model->getheader();
	...
	{
		$return = $this->Asb_model->getkegiatan();
	...
	{
		$return = $this->Asb_model->getReqById($this->get('id', TRUE));
