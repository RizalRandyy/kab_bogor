			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row mt-2">
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:25px; margin-bottom:25px;">
						<h3><?= $title ?></h3>
						<span>Usulan > Isian SSH > SSH</span>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:37px;">
						<?php if ($users['role_access']['usulan_spesifikasi_item']['accessadd_usulan_spesifikasi_item'] == 'on') { ?>
									...
									<table class="table table-striped table-md" style="font-size: 12px;">
										...
										<tbody>
											...
											<tr ng-show="message != null">
												<td colspan="9" class="text-center" ng-bind="message"></td>
											</tr>
											<tr>
											...
											<tr ng-hide="loading" dir-paginate="(key, value) in data|itemsPerPage:itemsPerPage" total-items="total_count" current-page="curPage" pagination-id="paginateID">
												...
												<td ng-bind="value.idKelompok"></td>
												...
												<?php if ($users['role_access']['spesifikasi_item']['accessedit_spesifikasi_item'] == 'on' || $users['role_access']['spesifikasi_item']['accessdelete_spesifikasi_item'] == 'on') { ?>
													<td class="text-center" style="white-space: nowrap;">
														...
														<?php } ?>
														<?php if ($users['role_access']['spesifikasi_item']['accessedit_spesifikasi_item'] == 'on') { ?>
															<a href="" class="btn btn-success btn-sm p-1" title="Edit: {{value.idKelompok}}" ng-click="edit(value)" ng-if="value.status != 'disetujui'">
