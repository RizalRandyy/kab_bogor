...
class Spesifikasi_item extends My_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('Spesifikasi_item_model');
	}

	public function index_get()
	{
		$this->data['title'] = 'Data Spesifikasi Item';
		$this->data['page'] = 'spesifikasi_item';
		$this->data['version'] = 'spesifikasi_item';
		$this->data['css'] = [
			'assets/plugins/animate/animate.min.css'
		];

		$this->data['js'] = array(
			'assets/js/app/spesifikasi_item.js?' . rand(),
	...
	{
		$return = $this->Spesifikasi_item_model->getkel_item();
	...
	public function saveData_post()
	{
		...
		$return = $this->Spesifikasi_item_model->saveData($params);
	...
	{
		$return = $this->Spesifikasi_item_model->deleteReq($this->post('id', TRUE));
		$this->response($return, $return['status']);
	}
}
