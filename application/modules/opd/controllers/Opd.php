...
class Opd extends My_Controller
{
	...
	{
		$this->data['title'] = 'Organisasi Perangkat Daerah (OPD)';
		$this->data['page'] = 'opd';
		$this->data['version'] = 'opd';
		$this->data['css'] = [
			'assets/plugins/animate/animate.min.css'
		];

		$this->data['js'] = array(
			'assets/js/app/opd.js?' . rand(),
	...
	{
		$return = $this->Opd_model->getData($this->get(),$this->data['users']);
		$return['header'] = $this->Opd_model->getheader();
	...
	public function form_get()
	{
		...
		$this->data['title'] = ucfirst($segment).' OPD';
		$this->data['page'] = 'tambah_opd';
		$this->data['version'] = $this->uri->segment(2);
		$this->data['id'] = @$this->get('id')?:null;

		$this->data['js'] = array(
			'assets/js/app/tambah_opd.js?' . rand(),
			'assets/plugins/sweetalert2/dist/sweetalert2.all.min.js',
	...
	public function saveData_post()
	{
		...
		$return = $this->Opd_model->saveData($params);
	...
	{
		$return = $this->Opd_model->getReqById($this->get('id'),$this->data['users']);
	...
	{
		$return = $this->Opd_model->deleteReq($this->post('id'));
		$this->response($return, $return['status']);
	}
}
