...
class Jenis_dokumen extends My_Controller
{
	...
	{
		$this->data['title'] = 'Jenis Dokumen';
		$this->data['page'] = 'jenis_dokumen';
		$this->data['version'] = 'jenis_dokumen';
		$this->data['css'] = [
			'assets/plugins/animate/animate.min.css'
		];

		$this->data['js'] = array(
			'assets/js/app/jenis_dokumen.js?' . rand(),
	...
	{
		$return = $this->Jenis_dokumen_model->getData($this->get(),$this->data['users']);
		$return['header'] = $this->Jenis_dokumen_model->getheader();
	...
	public function form_get()
	{
		...
		$this->data['title'] = ucfirst($segment).' Jenis Dokumen';
		$this->data['page'] = 'tambah_jenis_dokumen';
		$this->data['version'] = $this->uri->segment(2);
		$this->data['id'] = @$this->get('id')?:null;

		$this->data['js'] = array(
			'assets/js/app/tambah_jenis_dokumen.js?' . rand(),
			'assets/plugins/sweetalert2/dist/sweetalert2.all.min.js',
	...
	public function saveData_post()
	{
		...
		$return = $this->Jenis_dokumen_model->saveData($params);
	...
	{
		$return = $this->Jenis_dokumen_model->getReqById($this->get('id'),$this->data['users']);
	...
	{
		$return = $this->Jenis_dokumen_model->deleteReq($this->post('id'));
		$this->response($return, $return['status']);
	}
}
