			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row mt-2">
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:25px; margin-bottom:25px;">
						<h3><?= $title ?></h3>
						<span>Dokumen > Jenis Dokumen</span>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:37px;">
						<?php if ($users['role_access']['jenis_dokumen']['accessadd_jenis_dokumen'] == 'on') { ?>
									...
									<table class="table table-striped table-md" style="font-size: 12px;">
										<thead>
											<tr>
												...
												<?php if ($users['role_access']['jenis_dokumen']['accessedit_jenis_dokumen'] == 'on' || $users['role_access']['jenis_dokumen']['accessdelete_jenis_dokumen'] == 'on') { ?>
										...
										<tbody>
											...
											<tr ng-hide="loading" dir-paginate="(key, value) in data|itemsPerPage:itemsPerPage" total-items="total_count" current-page="curPage" pagination-id="paginateID">
												...
												<td ng-bind="value.jenis_dokumen"></td>
												<?php if ($users['role_access']['jenis_dokumen']['accessedit_jenis_dokumen'] == 'on' || $users['role_access']['jenis_dokumen']['accessdelete_jenis_dokumen'] == 'on') { ?>
													<td class="text-center" style="white-space: nowrap;">
														<?php if ($users['role_access']['jenis_dokumen']['accessedit_jenis_dokumen'] == 'on') { ?>
															<a href="" class="btn btn-success btn-sm p-1" title="Edit: {{value.id}}" ng-click="edit(value)">
																<i class="fas fa-edit"></i>&nbsp;
															</a>
														<?php } ?>
														<?php if ($users['role_access']['jenis_dokumen']['accessdelete_jenis_dokumen'] == 'on') { ?>
															<a href="" class="btn btn-danger btn-sm p-1" title="Delete: {{value.id}}" ng-click="delete(value)">
