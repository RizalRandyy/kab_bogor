			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="row mt-2">
					<div class="col-lg-6 col-md-6 col-sm-6" style="color:white; margin-top:25px; margin-bottom:25px;">
						<h3><?= $title ?></h3>
						<span>Dokumen > Jenis Dokumen > <?= $title ?></span>
					</div>
				</div>
				<div class="card">
					<div class="card-body">
										...
										<div class="col-md-6 col-lg-12">
											<form>
												<div class="form-group row">
													<label for="namaOpd" class="col-sm-4 col-form-label text-sm">Jenis Dokumen</label>
													<div class="col-sm-8">
														<input type="text" class="form-control form-control-sm text-sm" id="jenis_dokumen" name="jenis_dokumen" ng-model="jenis_dokumen" placeholder="Input Jenis Dokumen">
													</div>
												</div>
											</form>
										</div>
